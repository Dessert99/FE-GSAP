...
export function BasicTriggerExample() {
  ...
  // ScrollTrigger의 trigger 대상이다. scroller 문자열이 다른 예제와 섞이지 않도록 ref로 넘긴다.
  ...
  useGSAP(
    () => {
      ...
      gsap.from(card.current, {
        ...
        scrollTrigger: {
          trigger: card.current, // 이 요소가 스크롤 기준점이다
  ...
  return (
    <div ref={container} className="scroll-demo">
      ...
      <div ref={card} className="scroll-card scroll-card--basic">
        Basic trigger
      </div>
