...
import { gsapToReferences } from './gsap-to.references'
import './gsap-to.css'
  ...
  return (
    <article className="gsap-to-page">
      <header className="gsap-to-page__header">
        ...
        <div className="gsap-to-page__title-row">
          <h1>gsap.to()</h1>
          <OfficialDocsLink {...gsapToReferences.method} />
        </div>
        <p>
      ...
      <section className="fundamentals-section" aria-labelledby="api-items-title">
        ...
        <div className="fundamentals-section__examples">
          <DemoPanel
            ...
            references={gsapToReferences.basicMovement}
          >
          ...
          <DemoPanel
            ...
            references={gsapToReferences.multipleProperties}
          >
          ...
          <DemoPanel
            ...
            references={gsapToReferences.relativeValue}
          >
          ...
          <DemoPanel
            ...
            references={gsapToReferences.functionValue}
          >
      ...
      <section className="fundamentals-section" aria-labelledby="situation-examples-title">
        ...
        <div className="fundamentals-section__examples">
          <DemoPanel
            ...
            references={gsapToReferences.multipleTargets}
          >
          ...
          <DemoPanel
            ...
            references={gsapToReferences.cardFeedback}
          >
            <CardFeedbackExample />
          </DemoPanel>
        </div>
