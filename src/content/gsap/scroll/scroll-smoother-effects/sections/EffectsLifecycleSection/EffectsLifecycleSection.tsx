/** effects discovery·refresh·removal을 smoother 전체 lifecycle과 분리한다. */
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <code>kill()</code>은 smoother 전체를 정리할 때 사용합니다.
      </p>
      <p>
        reduced motion에서는 <code>smooth(0)</code>과 effect removal을
        결과로 정합니다. 이 정적 페이지는 실제 DOM transform을 만들지 않으므로
        읽기 순서와 native browser scrolling을 그대로
        둡니다.
      </p>
    </section>
  )
