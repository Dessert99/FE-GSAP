/** P43의 아홉 lifecycle canonical과 local source identity를 고정한다. */
export const scrollTriggerLifecycleMeta = {
  ...
  summary:
    '하나의 owned trigger에서 enable·disable·kill과 instance/global refresh, event ordering, sort, update의 범위를 비교합니다.',
