...
export function PageCoverage() {
  return (
    <nav className="placement-coverage" aria-label="Timeline child 배치 학습 순서">
      <div className="placement-coverage__summary">
        ...
        <p>
          Timeline의 배치 API 다섯 개에서 확인한 핵심 동작 {timelineChildPlacementCoverage.officialSourceItems}개를 "좌표는 누구
