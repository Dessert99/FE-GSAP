  ...
  return (
    <div ref={runtime.scope}>
      <InteractiveExample
        ...
        description="한 대상에서 complex string, 서로 다른 단위, CSS custom property를 하나씩 실행합니다. 먼저 mode를 고른 뒤 결과를 예상하고 실행하세요."
        ...
        changes={[describeChange(runtime.mode), 'camelCase property와 --custom-property 이름이 실제 vars와 code panel에서 같습니다.']}
