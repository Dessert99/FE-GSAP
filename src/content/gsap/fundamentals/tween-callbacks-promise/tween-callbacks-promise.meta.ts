...
/** 공식 source item 17개를 "만든 뒤에 손대기"와 "완료 기다리기"라는 두 상황의 다섯 단계에 대응시킨다. */
export const tweenCallbacksPromiseSections = [
  { number: '01', id: 'after-creation', title: '이미 만들어진 Tween에 손대야 할 때', sourceItems: 4 },
