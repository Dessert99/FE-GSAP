/** 두 공식 페이지가 게시하지 않은 범위와 다른 페이지에서 설명할 개념을 명시해 추측을 막는다. */
...
// 이 페이지가 전제로만 쓰고 자세한 설명은 연결된 페이지에 있는 개념들
const otherOwners = [
  ...
  { label: '화면 조건에 따라 다시 만들기 (gsap.matchMedia())', href: '/fundamentals/responsive-motion' },
  {
    ...
    href: '/fundamentals/timeline-basics',
  },
  {
    label: 'ScrollTrigger',
    href: '/fundamentals/scroll-trigger-create',
  },
]
    ...
    <section id="boundaries" className="context-page__section" aria-labelledby="boundaries-title">
      ...
      <div className="context-page__note">
        <p>
          ...
          <strong>범위 지정</strong>이라는 역할만, Context의 scope와 이어지는 만큼만 설명합니다. 나머지 utility method의 명세는
          별도 학습 페이지에서 다룹니다.
        </p>
      </div>
    </section>
