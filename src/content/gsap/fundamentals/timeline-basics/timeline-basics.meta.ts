...
export const timelineBasicsMeta = {
  ...
  summary:
    'Tween 여러 개의 순서와 겹침을 개별 delay로 계산하지 않고 Timeline에 child로 배치하는 방법을 다룹니다. Timeline 생성, vars, 네 child creator, position과 중첩의 기본 계약을 확인합니다.',
...
/** 공식 source item 116개를 "Timeline을 만들고 → child를 채우고 → 위치를 정한다"는 여덟 단계에 대응시킨다. */
export const timelineBasicsSections = [
  { number: '01', id: 'why-timeline', title: 'delay를 손으로 계산하지 않으려면', sourceItems: 8 },
  { number: '02', id: 'timeline-instance', title: 'gsap.timeline()이 돌려주는 Timeline', sourceItems: 9 },
