...
export function PlayheadValuesExample() {
  // 훅이 제공한 descriptor·control·관찰값을 표시 계층에서 받는다.
...
const totalProgress = tween.totalProgress()
const totalTime = tween.totalTime()`
    ...
    <div ref={scope}>
      <InteractiveExample
        ...
        propertyDetails={[
          ...
          { name: 'time()', type: 'number | self', defaultValue: 'getter', acceptedValues: 'current cycle의 초' },
          { name: 'totalProgress()', type: 'number | self', defaultValue: 'getter', acceptedValues: '전체 repeats 0–1' },
          { name: 'totalTime()', type: 'number | self', defaultValue: 'getter', acceptedValues: '전체 repeats·repeatDelay의 초' },
        ]}
