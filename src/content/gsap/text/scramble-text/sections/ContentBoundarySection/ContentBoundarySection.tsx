  ...
  return (
    <section id="content-boundary" aria-labelledby="scramble-boundary-title">
      ...
      <p>
        ...
        <code>innerHTML</code>을 쓰므로, 이 예제는 plugin이 바꿔도 되는
        plain-text target만 사용하고 cleanup에서 original HTML을 복원합니다.
      </p>
      <p>
        intermediate DOM은 무작위 문자라 읽기 대상이 아닙니다. 따라서 final
        phrase는 animation target 밖에서 고정된 text로 제공하고, live region으로
        중간 text를 반복해서 알리지 않습니다.
      </p>
    </section>
  )
}
