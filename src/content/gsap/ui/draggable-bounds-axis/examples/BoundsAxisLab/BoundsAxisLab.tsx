/** bounded tray의 한 target을 pointer와 keyboard에서 같은 constraint descriptor로 관찰한다. */
import { InteractiveExample } from '../../../../../../components/demo/InteractiveExample/InteractiveExample'
import './BoundsAxisLab.css'
import { useBoundsAxisAnimation } from './useBoundsAxisAnimation'

export function BoundsAxisLab() {
