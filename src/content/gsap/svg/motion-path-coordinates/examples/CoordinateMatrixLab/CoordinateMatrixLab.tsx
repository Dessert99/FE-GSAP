      ...
      <div ref={scope}>
        ...
        >
          <g transform="translate(45 35) rotate(-12) scale(1.1)">
            <circle ref={fromRef} cx="35" cy="35" r="16" />
            <line x1="35" y1="35" x2="65" y2="35" />
          </g>
          <g transform="translate(140 60) rotate(8)">
            <rect ref={toRef} x="0" y="0" width="120" height="80" fill="none" />
            <line x1="0" y1="40" x2="120" y2="40" />
            <line x1="60" y1="0" x2="60" y2="80" />
            <circle ref={overlayRef} r="5" opacity="0" />
          </g>
        </svg>
      </div>
